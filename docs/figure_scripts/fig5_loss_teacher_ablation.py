...
axL.set_title("(a) Loss function ablation", weight="bold")
...
fig.savefig(os.path.join(out, "fig5_loss_teacher_ablation.pdf"), bbox_inches="tight",
            pad_inches=0.05)
plt.close(fig)
print(f"saved {os.path.join(out, 'fig5_loss_teacher_ablation.png')} and .pdf")
